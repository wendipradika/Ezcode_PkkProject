...
<body>
    <div class="container2">
            <img src="<?=BASEURL?>/image/reg.png" class="img2">
                <div class="persegi2">
                <div class="kotakdaftar">
                    <h2>SILAHKAN DAFTAR</h2>
                    <form action="<?= BASEURL?>/register/proses" method="post">
                        ...
                        <p class="p1">Sudah punya Akun?<a class="lp" href="<?= BASEURL?>/login">Login!</a></p>
                </div>
            </div>
    </div>
</body>
